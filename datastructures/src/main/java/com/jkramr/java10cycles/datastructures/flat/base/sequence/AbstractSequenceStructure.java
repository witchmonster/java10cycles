package com.jkramr.java10cycles.datastructures.flat.base.sequence;

import com.jkramr.java10cycles.datastructures.DataStructure;

public abstract class AbstractSequenceStructure<T>
  ...
  public boolean contains(T object) {
    Node<T> node = head;
    while (node != null) {
      if (object == null ? node.datum == null : object.equals(node.datum)) {
        return true;
      }
      node = node.nextNode;
    }
